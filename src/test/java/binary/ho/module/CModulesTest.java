...
class CModulesTest {
    ...
    void getModuleByName() {
        ...
        // then
        assertEquals("file1", modules.get("file1").getModuleName());
        assertEquals("file2", modules.get("file2").getModuleName());
    }
    ...
    void returnMissingModuleWhenNotFound() {
        ...
        // then
        assertEquals(MissingModuleFactory.MISSING_MODULE, modules.get("nonexistent").getModuleName());
    }
}
